...
class RatingServiceImplTest {
    ...
    void saveNewRating() {
        ...
        StepVerifier
                .create(publisher)
                .assertNext(rating -> assertEquals(5, rating.getStars()))
                .verifyComplete();
    }
    ...
    void delete() {
        Rating data = new Rating("1", "1", 5);
        Mono<Rating> publisher = ratingService
                .createRating(data)
                .flatMap(rating -> ratingService.deleteRating(rating.getId()));
        StepVerifier
                .create(publisher)
                .expectNextMatches(rating -> rating.getStars() == 5)
                .expectNextCount(0)
                .verifyComplete();
    }
    ...
    void update() throws Exception {
        ...
        StepVerifier
                .create(publisher)
                .expectNextMatches(rating -> rating.getStars() == 4)
                .verifyComplete();
    }
