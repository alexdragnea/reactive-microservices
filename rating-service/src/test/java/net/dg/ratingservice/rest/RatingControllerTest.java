...
class RatingControllerTest {
    ...
    void getAllRatings() {
        ...
        Mockito
                .when(ratingService.findAllRatings())
        ...
        client
                ...
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.[0].bookId").isEqualTo("1")
                .jsonPath("$.[0].stars").isEqualTo(5)
                .jsonPath("$.[1].bookId").isEqualTo("2")
    ...
    void getBookById() {
        ...
        Mockito
                .when(ratingService.findRatingById(any()))
                .thenReturn(Mono.just(data));

        client
                .get()
                .uri("/rating/" + data.getId())
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    void saveBook() {
        ...
        Mockito
                .when(ratingService.createRating(any(Rating.class)))
                .thenReturn(Mono.just(data));

        client
                .post()
                .uri("/rating")
                .body(Mono.just(data), Rating.class)
                .exchange()
    ...
    void deleteBookById() {
        ...
        Mockito
                .when(ratingService.deleteRating(data.getId()))
                .thenReturn(Mono.just(data));
        client
                .delete()
                .uri("/rating/" + data.getId())
    ...
    void updateBookById() {
        ...
        Mockito.when(ratingService.updateRating(data, data.getId()))
